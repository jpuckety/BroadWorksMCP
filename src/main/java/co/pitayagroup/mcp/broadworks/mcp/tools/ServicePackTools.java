...
public class ServicePackTools {
    ...
    @Tool(name = "broadworks_list_service_packs",
    ...
    public List<ServicePackSummary> listServicePacks(
            @ToolParam(description = "The service provider id that owns the service packs")
    ...
    @Tool(name = "broadworks_get_service_pack",
    ...
    public ServicePackDetail getServicePack(
            @ToolParam(description = "The service provider id that owns the service pack")
            String serviceProviderId,
            @ToolParam(description = "The name of the service pack to inspect") String servicePackName,
            @ToolParam(required = false,
                    description = "Optional BroadWorks resource id when multiple connections are configured")
            String resourceId) {
        log.debug("tool broadworks_get_service_pack invoked (serviceProviderId={}, servicePackName={}, "
                + "resourceId={})", serviceProviderId, servicePackName, resourceId);
        final String spId = require(serviceProviderId, "serviceProviderId");
        final String packName = require(servicePackName, "servicePackName");
        final BroadWorksServer server = connect(resourceId);
        final ServiceProvider sp = populatedServiceProvider(server, spId);
        return getDetail(sp, spId, packName);
    }

    @Tool(name = "broadworks_create_service_pack",
    ...
    public ServicePackDetail createServicePack(
            @ToolParam(description = "The service provider id that will own the new service pack")
            String serviceProviderId,
            @ToolParam(description = "The name for the new service pack (must be unique within the service provider)")
            String servicePackName,
            @ToolParam(required = false, description = "Optional description for the service pack")
            String description,
            @ToolParam(required = false,
    ...
    @Tool(name = "broadworks_modify_service_pack",
    ...
    public ServicePackDetail modifyServicePack(
            @ToolParam(description = "The service provider id that owns the service pack")
            String serviceProviderId,
            @ToolParam(description = "The current name of the service pack to modify") String servicePackName,
            @ToolParam(required = false,
    ...
    @Tool(name = "broadworks_delete_service_pack",
    ...
    public String deleteServicePack(
            @ToolParam(description = "The service provider id that owns the service pack")
            String serviceProviderId,
            @ToolParam(description = "The name of the service pack to delete") String servicePackName,
            @ToolParam(required = false,
                    description = "Optional BroadWorks resource id when multiple connections are configured")
            String resourceId) {
